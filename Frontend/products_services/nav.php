    ...
    <!-- Section for nav bar-->
        ...
        <div class="navba">
          ...
          <div class="nav-items">
            ...
            <div><a href="Frontend/mainpages/contactus.php">Contact</a></div>
            <div class="dropdown registration">
              <a href="#">Register</a>
              <div class="dropdown-content">
                <div><a href="Frontend/Resident/resident.php">Resident Registration</a></div>
                <div><a href="company_frontend.php">Business Registration</a></div>
                <div><a href="Frontend/products_services/products.php">Product Registration</a></div>
              </div>
            </div>
        </div>
