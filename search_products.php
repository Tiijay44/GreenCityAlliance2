...
if ($searchTerm == true){
            if ($result->num_rows > 0) {
              ...
              echo "<marquee behavior='scroll' scrollamount='9' direction='right' onmouseover='this.stop();' onmouseout='this.start();'><h4 style=''>No products found matching your search</h4></marquee>";
            }
          }else{
