        ...
        <div class="container_fluid dashboard_container">
            ...
            <table id="display_residents" class="display_residents dashboard_table">
                <thead>
                    <tr>
                        <td colspan="8">
                            <p align="lef"> <a href="resident.php"> Add Resident </a> </p>
                        </td>
                    </tr>
                    <tr>
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) { ?>
                    ...
                    <tr>
                        ...
                        <td><a href="update_resident_frontend.php?Resident_id=<?php echo $row['Resident_id']; ?>">
                            Update</a>/<a href="delete_resident.php?Resident_id=<?php echo $row['Resident_id']; ?>">
                            Delete</a></td>
                        <!-- <td class="table_btn">
                            <td width="50px"><a id="btn_update" class="btn_update" href="update_resident_frontend.php?Resident_id=">
                            <i name="" class='bx bxs-edit-alt'></i></a>

                            <a id="btn_delete" href="delete_resident.php?Resident_id=">
